...
// source: furya-official/magecommunity/v1beta1/query.proto
...
func init() {
	...
	proto.RegisterType((*QueryLegacyCommunityPoolRequest)(nil), "mage.community.v1beta1.QueryLegacyCommunityPoolRequest")
	proto.RegisterType((*QueryLegacyCommunityPoolResponse)(nil), "mage.community.v1beta1.QueryLegacyCommunityPoolResponse")
}

func init() {
	proto.RegisterFile("furya-official/magecommunity/v1beta1/query.proto", fileDescriptor_f236f06c43149273)
}
...
func (c *queryClient) LegacyCommunityPool(ctx context.Context, in *QueryLegacyCommunityPoolRequest, opts ...grpc.CallOption) (*QueryLegacyCommunityPoolResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mage.community.v1beta1.Query/LegacyCommunityPool", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_LegacyCommunityPool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mage.community.v1beta1.Query/LegacyCommunityPool",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "furya-official/magecommunity/v1beta1/query.proto",
}
