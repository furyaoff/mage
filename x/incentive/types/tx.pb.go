...
// source: furya-official/mageincentive/v1beta1/tx.proto
...
func init() {
	...
	proto.RegisterType((*MsgClaimUSDXMintingReward)(nil), "mage.incentive.v1beta1.MsgClaimUSDXMintingReward")
	proto.RegisterType((*MsgClaimUSDXMintingRewardResponse)(nil), "mage.incentive.v1beta1.MsgClaimUSDXMintingRewardResponse")
...
func init() { proto.RegisterFile("furya-official/mageincentive/v1beta1/tx.proto", fileDescriptor_b1cec058e3ff75d5) }
...
func (c *msgClient) ClaimUSDXMintingReward(ctx context.Context, in *MsgClaimUSDXMintingReward, opts ...grpc.CallOption) (*MsgClaimUSDXMintingRewardResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mage.incentive.v1beta1.Msg/ClaimUSDXMintingReward", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_ClaimUSDXMintingReward_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mage.incentive.v1beta1.Msg/ClaimUSDXMintingReward",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "furya-official/mageincentive/v1beta1/tx.proto",
}
